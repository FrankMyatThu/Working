...
app.factory('countryEditDataFactory', function ($http) {
    ...
    function updateCountry(_Country_Criteria_Model) {
        return $http({
            method: 'POST',
...
app.controller('CountryEditController', function ($scope, $http, $window, $uibModal, $timeout, countryEditDataFactory) {
    ...
    $scope.deletePage = function () {
        ...
        if ($scope.checkboxControl.IsSelectedAllTotally) {
            ...
            countryEditDataFactory.updateCountry(List_Country_Criteria_Model)
...
app.directive("ddlRecordFilterCount", ['countryEditDataFactory', function (countryEditDataFactory) {
    return {
        restrict: 'A',
        transclude: true,
        scope: false,
